...
/obj/item/reagent_containers/food/snacks/sushi_rice
	...
	icon = 'newerastation/icons/obj/food.dmi'
...
/obj/item/reagent_containers/food/snacks/sea_weed
	name = "Sea Weed Sheet"
	desc = "A thin, light salt sheet of plant matter. Commonly used in sushi recipes."
	icon = 'newerastation/icons/obj/food.dmi'
	icon_state = "sushi_seaweed"
...
/obj/item/reagent_containers/food/snacks/sushi_basic
	name = "Funa Hosomaki"
	desc = "A small cylindrical piece of kudzu skin filled with rice and fish."
	icon = 'newerastation/icons/obj/food.dmi'
